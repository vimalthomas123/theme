<?php 
/* Template Name: Food Safety and Quality page */ 
...
<?php
      if( have_rows('content_section_food_safety') ):
            while ( have_rows('content_section_food_safety') ) : the_row();
                  if( get_row_layout() == 'excellence_first' ):
...
?>
                        <section class="manufacturing__certification">
                              <div class="container">
                                    <?php 
                                          if(have_rows('certifications_group')):
                                                while(have_rows('certifications_group')):the_row();
                                                      $title = get_sub_field('title');
                                                      $image_img = get_sub_field('image');
                                    ?>
                                                      <?php if($title): echo'<h2 class="title__secondary">'.$title.'</h2>'; endif;?>
                                                      <div class="certifications__logo__row">
                                                            <?php foreach( $image_img as $image_id ): ?>
                                                                  <?php if($image_id): echo'<img src="'.$image_id['url'].'" alt="'.$image_id['alt'].'">'; endif;?>
                                                            <?php endforeach; ?>
                                                      </div>
                                    <?php
                                                endwhile;
