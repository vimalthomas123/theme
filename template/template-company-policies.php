<?php 
/* Template Name: Company Policies page */ 
...
<?php
      if( have_rows('content_section_food_safety') ):
            while ( have_rows('content_section_food_safety') ) : the_row();
                  if( get_row_layout() == 'iffco_code_of_conduct' ):
                        $color = get_sub_field('color');
                        $title = get_sub_field('title');
                        $description = get_sub_field('description');
                        $image_img = get_sub_field('image');
                        $image = $image_img['url'];
                        $cta_a = get_sub_field('cta_a');
                        $file_upload = get_sub_field('file_upload');
?>
                        <section class="vision__banner vision__banner--content--description" style="--bg-color: <?php echo $color;?>">
                              <div class="container">
                                    ...
                                    <div class="vision__banner__content">
                                          ...
                                          <?php if($cta_a): echo'<a href="'.$file_upload.'" download="download" class="cta__primary cta__primary--cta__normal">'.$cta_a.'</a>'; endif;?>
                                    </div>
                              </div>
                        </section>
<?php 
                  elseif( get_row_layout() == 'image_&_text_group' ):
                        $color = get_sub_field('color');
                        $image_img = get_sub_field('image');
                        $image = $image_img['url'];
                        $title = get_sub_field('title');
...
?>
                        <section class="value__flexible__grid value__flexible__grid__flip" style="--bg-color: <?php echo $color;?>">
                              <div class="container">
                                    <div class="row">
                                          ...
                                          <div class="col-12 col-lg-6">
                                                <div class="value__flexible__grid__content">
                                                      ...
                                                      ?>
                                                            <a class="cta__primary cta__primary--cta__normal" href="<?php echo esc_url( $learn_more_url ); ?>" target="<?php echo esc_attr( $learn_more_target ); ?>"><?php echo esc_html( $learn_more_title ); ?></a>
                                                      <?php endif; ?>
                                                      <?php if($file_upload): echo'<a href="'.$file_upload.'" download="download" class="cta__primary cta__primary--cta__normal">'.$button_text.'</a>'; endif;?>
                                                </div>
                                          </div>
                                    </div>
                              </div>
