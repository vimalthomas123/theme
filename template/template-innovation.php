...
<?php 
        if( have_rows('content_section_innovation') ):
            while ( have_rows('content_section_innovation') ) : the_row();
                        ...
                        <section class="vision__banner" style="--bg-color: <?php echo $color;?>">
                              <div class="container">
                                    ...
                                    <div class="vision__banner__content">
                                          ...
                                          <?php if($description_c): echo''.$description_c.''; endif;?>
                                    </div>
                              </div>
                        </section>
<?php
                    elseif( get_row_layout() == 'left_and_right_content' ):
                        $color = get_sub_field('color');
                        $title = get_sub_field('title');
                        ...
                        $image = $image_img['url'];
?>
                        <section class="value__flexible__grid value__flexible__grid--alternate value__flexible__grid__flip" style="--bg-color: <?php echo $color;?>">
                              <div class="container">
                                    <div class="row">
