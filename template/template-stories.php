                        ...
                        $args = array(
                              ...
                              if ( $result-> have_posts() ) :
                                    while ( $result->have_posts() ) : $result->the_post();
                                          ...
                                          $card_bg_image = get_field('card_bg_image');
                                          $link = get_permalink();

                  ?>
                                          <div class="col-12 col-sm-6 col-xl-4">
                                                <a href="<?php echo $link;?>" class="story__item" style="--overlay-color: <?php echo $card_color;?>">
                                                      <img src="<?php echo $card_bg_image;?>" alt="">
                                                      <span class="overlay"></span>
                                                      <h4><?php echo $title;?></h4>
                                                      <span><?php echo $publish_date;?></span>
                                                      <svg xmlns="http://www.w3.org/2000/svg" width="31.216" height="29.026" viewBox="0 0 31.216 29.026">
                                                            <g id="Group_32" data-name="Group 32" transform="translate(-159.912 -1183.002)">
                                                                  <path id="Path_97" data-name="Path 97" d="M190.421,1195.712l-14.9,14.9-14.9-14.9" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="2" />
                                                                  <line id="Line_2" data-name="Line 2" y1="27.611" transform="translate(175.52 1183.002)" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="2" />
                                                            </g>
                                                      </svg>
                                                </a>
                                          </div>
