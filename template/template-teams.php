...
<?php if( have_rows('teams') ):
        ...
        ?>
<section class="value__flexible__grid value__flexible__grid__flip" style="--bg-color: #fff">
    <div class="container">

      <div class="row">
        <div class="col-12 col-lg-6">
          <div class="value__flexible__grid__content">
            <h3><?php the_sub_field('teams_title'); ?></h3>
            <p><?php the_sub_field('teams_content'); ?></p>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="value__flexible__grid__image__wrap">
            <img src="<?php the_sub_field('teams_image'); ?>" alt="">
          </div>
        </div>
      </div>
