...
<?php
      if( have_rows('content_section_values') ):
            while ( have_rows('content_section_values') ) : the_row();
                  if( get_row_layout() == 'vision' ):
...
?>
                        <section class="vision__banner" style="--bg-color: <?php echo $color ;?>">
                              <div class="container">
                                    <?php if($bg): echo '<div class="featured__image">
                                          <img src="'.$bg.'" alt="'.$bg_img['alt'].'">
                                    </div>'; endif;?>
                                    <div class="vision__banner__content">
                                          <?php if($main_title): echo'<h2>'.$main_title.'</h2>'; endif;?>
...
?>
                        <?php if($image_img): echo'<section class="value__flexible__grid" style="--bg-color: '.$color.'">
                              <div class="container">
                                    <div class="row">
                                          <div class="col-12 col-lg-6">
                                                <div class="value__flexible__grid__image__wrap">
                                                      <img src="'.$image_img['url'].'" alt="'.$title.'">
                                                </div>
                                          </div>
                                          <div class="col-12 col-lg-6">
                        ...
                        <section class="core__values__grid__section">
                              <div class="container">
                                    <div class="core__values__grid">
                                          <?php 
                                                if(have_rows('values_group')):
                                                      while(have_rows('values_group')):the_row();
                                                            $color = get_sub_field('color');
                                                            $icon = get_sub_field('icon');
                                                            $title = get_sub_field('title');
                                                            $sub_title = get_sub_field('sub_title');
                                          ?>
                                                            <div class="core__values__grid__item" style="--card-color: <?php echo $color;?>">
                                                                  <?php if($icon): echo'<div class="core__values__grid__item__icon">
                                                                        <img src="'.$icon.'" alt="'.$title.'">
                                                                  </div>'; endif;?>
                                                                  <?php if($title): echo'<h4>'.$title.'</h4>'; endif;?>
                                                                  <?php if($sub_title): echo'<h5>'.$sub_title.'</h5>'; endif;?>
                                                            </div>
                                          <?php
                                                      endwhile;
                                                endif;
