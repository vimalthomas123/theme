...
add_action('init', 'ab_category_taxonomy', 0);
function ab_category_taxonomy()
{

    $labels = array(
        'name' => _x('ab', 'taxonomy general name'),
        'singular_name' => _x('Category', 'taxonomy singular name'),
        'search_items' =>  __('Search ab'),
        'all_items' => __('All ab'),
        'parent_item' => __('Parent Category'),
        'parent_item_colon' => __('Parent Category:'),
        'edit_item' => __('Edit Category'),
    ...
    register_taxonomy('ab-category', array('brands'), array(
        'hierarchical' => true,
        'labels' => $labels,
        'show_ui' => true,
        'show_in_rest' => true,
