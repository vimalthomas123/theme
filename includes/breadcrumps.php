...
//     $separator              = '/';
    ...
    $breadcrumbs_class      = 'bread__crumbs';
      ...
      //   echo '<li class="separator separator-home"> ' . $separator . ' </li>';
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if (is_tax()) {
                ...
                $taxonomy_name = get_taxonomy($current_term->taxonomy)->labels->singular_name;
                echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><div class="bread-cat bread-custom-post-type-' . $post_type . '" title="' . $taxonomy_name . '">' . $taxonomy_name . '</div></li>';
            }
            ...
            if($post_type != 'post') {
                ...
                if( $post_type == 'csrs'){
                    $post_type_object = get_post_type_object($post_type);
                    $post_type_archive = get_home_url();
                    
              
                echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><a class="bread-cat bread-custom-post-type-' . $post_type . '" href="' . $post_type_archive . '" title="' . $post_type_object->labels->name . '"> Corporate Social Responsibility</a></li>';
            //     echo '<li class="separator"> ' . $separator . ' </li>';
                }else{
                  
                    $post_type_object = get_post_type_object($post_type);
                    $post_type_archive = get_post_type_archive_link($post_type);
                    $brands_ = get_field('brands_','option');
                    $page_id = url_to_postid( $brands_ );
                    $page_title = get_the_title($page_id);

                echo '<li class="item-cat item-custom-post-type-' . $post_type . '"><a class="bread-cat bread-custom-post-type-' . $post_type . '" href="' . $brands_ . '" title="' . $page_title . '">' . $page_title . '</a></li>';
            //     echo '<li class="separator"> ' . $separator . ' </li>';
             }
